...
const cart = useSelector(state => state.cart)
 ...
 <Link to={"/"}>  <a href="#" className="flex items-center whitespace-nowrap text-2xl font-black">
  ...
  <nav aria-label="Header Navigation" className="peer-checked:pt-8 peer-checked:max-h-60 flex max-h-0 w-full flex-col items-center overflow-hidden transition-all lg:ml-24 lg:max-h-full lg:flex-row">
    ...
    <div className="my-4 flex items-center space-x-6 space-y-2 lg:my-0 lg:ml-auto lg:space-x-8 lg:space-y-0">
      ...
      <Link to={"/cart"} className="whitespace-nowrap rounded-xl bg-blue-700 px-5 py-3 font-medium text-white transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:ring-offset-2 hover:bg-blue-600"   >CART ({cart.length})</Link>
    </div>
  </nav>
</header>
